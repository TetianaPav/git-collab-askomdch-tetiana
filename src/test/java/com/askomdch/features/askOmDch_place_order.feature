...
#    NO NEED TO CHANGE ANY DATA!!!
  ...
  |	TMaxDar3	|	password	|	TMaxDar3@gmail.com 	|	Maximilian	|	Darden	    |	MaxDardenINC	|	United States (US)       	|	123 N Palatine rd	|	apt#321          	|	Chicago	|	IL     	|	60008	|	12345678	|	jeans       	|	Dark Brown Jeans    	|
  ...
  Scenario Outline: AskOmDch Place Order As a Guest with different address for delivery with create an account
    ...
    Examples:
      ...
      |	TMilMendoza3	    |	TMilMendoza3@gmail.com	  |	112233	  |	Miles	  | Mendoza     	|	 Bob INC      	|	 United States (US) 	|	 123 N Palatine rd 	|	 apt#321         	|	 Chicago 	|	 IL    	|	60008	|	12345678	|	 jeans        	|	 Dark Brown Jeans     	|	 Sara           	|	 Lee           	|	 SaraINC           	|	 United States (US) 	|	 145 Main St          	|	 apt#43               	|	 Apex      	|	 NC       |	27516	       |	 Thank you   	|

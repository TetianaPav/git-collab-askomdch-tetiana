Feature: AskOmDch User Registration Feature with Scenario Outline
  ...
  Scenario Outline: AskOmDch Register New User with Scenario Outline
    ...
    Examples:
      ...
      |	TChrOlivares2	|	TChrOlivares2@gmail.com	|	ChrOli21	|
 ...
 @smoke
  Scenario Outline: AskOmDch Register New User with Scenario Outline and Add Billing and Shipping Address
   ...
   Examples:
     ...
     |	TLonSandlin2	|	TLonSandlin2@gmail.com    |	LonSan21	|	Long	    |	Sandlin	    |	LonSandlin COR	|	 United States (US) 	|	Manor Avenue	    |	 apt#321         	|	 Chicago 	|	 IL    	|	60008	    |	12345678	|	Willie	                |	Morin	            |	WMorin COR	            |	 United States (US) 	|	Queen Street	            |	 apt#43               	    |	 Apex      	    |	CA	                |	27516	            |
